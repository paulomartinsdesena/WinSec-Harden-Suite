...
function Execute-Script {
    ...
    switch ($option) {
        ...
        2 { Write-Host "👥 Executando Configuração de Contas e Privilégios..." -ForegroundColor Yellow; Start-Process powershell.exe -ArgumentList "-ExecutionPolicy Bypass -File .\02.Configuring Accounts And Privileges.ps1" }
        3 { Write-Host "🔥 Configurando Firewall e Filtro de Tráfego..." -ForegroundColor Yellow; Start-Process powershell.exe -ArgumentList "-ExecutionPolicy Bypass -File .\03.Firewall And Traffic Filtering.ps1" }
        4 { Write-Host "🛠️  Removendo Serviços Desnecessários..." -ForegroundColor Yellow; Start-Process powershell.exe -ArgumentList "-ExecutionPolicy Bypass -File .\04.Removing Unnecessary Services.ps1" }
        5 { Write-Host "🛡️  Configurando Antivirus e Antimalware..." -ForegroundColor Yellow; Start-Process powershell.exe -ArgumentList "-ExecutionPolicy Bypass -File .\05.Antivirus and Antimalware.ps1" }
        6 { Write-Host "🕵️  Iniciando Auditoria e Monitoramento..." -ForegroundColor Yellow; Start-Process powershell.exe -ArgumentList "-ExecutionPolicy Bypass -File .\06.Auditing and Monitoring.ps1" }
        7 { Write-Host "🔒 Configurando Criptografia..." -ForegroundColor Yellow; Start-Process powershell.exe -ArgumentList "-ExecutionPolicy Bypass -File .\07.Cryptography.ps1" }
        8 { Write-Host "❌ Eliminando Protocolos ou Aplicações Inseguras..." -ForegroundColor Yellow; Start-Process powershell.exe -ArgumentList "-ExecutionPolicy Bypass -File .\08.Elimination of insecure protocols or applications.ps1" }
